...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['fraud_case', 'payment_log_entry', 'ledger_posting', 'inventory_movement'], 'action_targets': {'record': None, 'review': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
