"""Relation service seed for transaction_trace_record."""
...
RELATED_DOCS = [{'doc_id': 'fraud_case', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'payment_log_entry', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'ledger_posting', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'inventory_movement', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'source transaction context from linked records'}]
