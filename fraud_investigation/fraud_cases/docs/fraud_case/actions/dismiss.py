"""Action handler seed for fraud_case:dismiss."""
...
DOC_ID = "fraud_case"
ACTION_ID = "dismiss"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['opened', 'triaged', 'investigating', 'confirmed', 'dismissed'], 'transitions_to': None}
