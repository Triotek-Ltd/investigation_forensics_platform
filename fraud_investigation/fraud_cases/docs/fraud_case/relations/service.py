"""Relation service seed for fraud_case."""
...
DOC_ID = "fraud_case"
RELATED_DOCS = [{'doc_id': 'transaction_trace_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'suspicious_pattern_alert', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'fraud_alert', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'chargeback_case', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'source alert/transaction context from linked fraud/payment docs'}]
