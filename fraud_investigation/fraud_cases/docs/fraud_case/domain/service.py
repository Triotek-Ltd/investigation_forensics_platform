...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'case_status': 'status_flag'}, 'search_fields': ['title', 'reference_no', 'description', 'case_code', 'source_alert_referral', 'subject_or_transaction_scope'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'opened', 'lifecycle_states': ['opened', 'triaged', 'investigating', 'confirmed', 'dismissed', 'closed', 'archived'], 'terminal_states': ['closed', 'archived'], 'action_targets': {'create': None, 'triage': None, 'assign': None, 'investigate': None, 'confirm': 'confirmed', 'dismiss': None, 'close': 'closed', 'archive': 'archived'}}
