"""Business-domain service seed for Fraud Case."""
...
ARCHETYPE_PROFILE = {'workflow_profile': {'mode': 'case_flow', 'supports_assignment': True, 'supports_escalation': True}, 'reporting_profile': {'supports_snapshots': True, 'supports_outputs': False}, 'integration_profile': {'external_sync_enabled': False}, 'lifecycle_states': ['opened', 'triaged', 'investigating', 'confirmed', 'dismissed', 'closed', 'archived'], 'is_transactional': False}

CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'case_status': 'status_flag', 'related_transaction_trace_record': 'relation_collection', 'related_suspicious_pattern_alert': 'relation_collection', 'related_fraud_alert': 'relation_collection', 'related_chargeback_case': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'case_code', 'source_alert_referral', 'subject_or_transaction_scope'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'opened', 'lifecycle_states': ['opened', 'triaged', 'investigating', 'confirmed', 'dismissed', 'closed', 'archived'], 'terminal_states': ['closed', 'archived'], 'records_profile': {'record_class': 'business_record', 'legal_significance': 'standard', 'confidentiality': 'internal', 'official_copy_format': 'pdf', 'evidence_gaps': []}, 'record_contract': {'doc_kind': 'workflow_case', 'supports_attachments': True, 'supports_comments': True, 'supports_activity_log': True, 'supports_assignments': True, 'is_submittable': False, 'supports_submission_snapshot': True, 'supports_official_outputs': True, 'supports_evidence_pack': True, 'supports_signoff': False}, 'submission_snapshot_policy': {'enabled': True, 'trigger_action': 'submit', 'freeze_fields_after_snapshot': True, 'retain_snapshot_history': True, 'snapshot_label_template': '{reference_no}-{workflow_state}', 'trigger_actions': ['submit']}, 'signature_policy': {'enabled': False, 'mode': 'approval', 'required_roles': [], 'reason_required': False, 'counter_signature_required': False}, 'audit_policy': {'track_state_history': True, 'track_action_log': True, 'track_external_refs': True, 'require_reason_for_change': False, 'require_action_comment': False, 'hash_official_outputs': False}, 'records_management': {'retention_policy_ref': 'administration.office_administration.filing_records_management.retention_disposal.retention_policy', 'legal_hold_enabled': False, 'disposition_action': 'archive', 'immutable_after_submit': True, 'official_copy_on_submit': False, 'chain_of_custody_required': False, 'retention_trigger_field': None, 'legal_hold_field': None, 'disposition_actions': ['archive']}, 'legal_hold_policy': {'enabled': False, 'hold_field': None, 'restrict_disposition_while_active': True, 'allow_override_roles': []}, 'official_copy_policy': {'enabled': True, 'format': 'pdf', 'generate_on_submit': False, 'hash_outputs': False, 'include_audit_summary': True, 'include_attachments_index': True, 'trigger_actions': []}, 'evidence_policy': {'required_attachments': [], 'required_references': [], 'required_approvals': [], 'verification_fields': []}, 'chain_of_custody_policy': {'enabled': False, 'custody_event_field': None, 'require_transfer_reason': False, 'require_actor_identity': True}, 'display_runtime_hints': {'doc_key': 'fraud_case', 'supports_related_lookup': True, 'supports_fetch_rules': True, 'workflow_hints': {'relation_context': {'related_docs': ['transaction_trace_record', 'suspicious_pattern_alert', 'fraud_alert', 'chargeback_case'], 'borrowed_fields': ['source alert/transaction context from linked fraud/payment docs'], 'inferred_roles': ['auditor', 'finance officer', 'case owner']}, 'actors': ['auditor', 'finance officer', 'case owner'], 'action_actors': {'create': ['auditor'], 'assign': ['auditor'], 'confirm': ['finance officer'], 'close': ['case owner'], 'archive': ['case owner']}}, 'action_side_effects_file': 'side_effects.json', 'supports_official_copy': True, 'supports_evidence_timeline': True, 'supports_chain_of_custody': False}, 'action_contracts': {'create': {'rule': {'allowed_in_states': ['opened', 'triaged', 'investigating', 'confirmed', 'dismissed'], 'transitions_to': None}, 'requires_action_comment': False, 'requires_reason_for_change': False, 'requires_evidence': False, 'is_disposition_action': False, 'creates_submission_snapshot': False, 'creates_official_copy': False, 'requires_signature': False}, 'triage': {'rule': {'allowed_in_states': ['opened', 'triaged', 'investigating', 'confirmed', 'dismissed'], 'transitions_to': None}, 'requires_action_comment': False, 'requires_reason_for_change': False, 'requires_evidence': False, 'is_disposition_action': False, 'creates_submission_snapshot': False, 'creates_official_copy': False, 'requires_signature': False}, 'assign': {'rule': {'allowed_in_states': ['opened', 'triaged', 'investigating', 'confirmed', 'dismissed'], 'transitions_to': None}, 'requires_action_comment': False, 'requires_reason_for_change': False, 'requires_evidence': False, 'is_disposition_action': False, 'creates_submission_snapshot': False, 'creates_official_copy': False, 'requires_signature': False}, 'investigate': {'rule': {'allowed_in_states': ['opened', 'triaged', 'investigating', 'confirmed', 'dismissed'], 'transitions_to': None}, 'requires_action_comment': False, 'requires_reason_for_change': False, 'requires_evidence': False, 'is_disposition_action': False, 'creates_submission_snapshot': False, 'creates_official_copy': False, 'requires_signature': False}, 'confirm': {'rule': {'allowed_in_states': ['opened', 'triaged', 'investigating', 'confirmed', 'dismissed'], 'transitions_to': 'confirmed'}, 'requires_action_comment': False, 'requires_reason_for_change': False, 'requires_evidence': False, 'is_disposition_action': False, 'creates_submission_snapshot': False, 'creates_official_copy': False, 'requires_signature': False}, 'dismiss': {'rule': {'allowed_in_states': ['opened', 'triaged', 'investigating', 'confirmed', 'dismissed'], 'transitions_to': None}, 'requires_action_comment': False, 'requires_reason_for_change': False, 'requires_evidence': False, 'is_disposition_action': False, 'creates_submission_snapshot': False, 'creates_official_copy': False, 'requires_signature': False}, 'close': {'rule': {'allowed_in_states': ['opened', 'triaged', 'investigating', 'confirmed', 'dismissed'], 'transitions_to': 'closed'}, 'requires_action_comment': False, 'requires_reason_for_change': False, 'requires_evidence': False, 'is_disposition_action': False, 'creates_submission_snapshot': False, 'creates_official_copy': False, 'requires_signature': False}, 'archive': {'rule': {'allowed_in_states': ['opened', 'triaged', 'investigating', 'confirmed', 'dismissed'], 'transitions_to': 'archived'}, 'requires_action_comment': False, 'requires_reason_for_change': False, 'requires_evidence': False, 'is_disposition_action': True, 'creates_submission_snapshot': False, 'creates_official_copy': False, 'requires_signature': False}}, 'action_targets': {'create': None, 'triage': None, 'assign': None, 'investigate': None, 'confirm': 'confirmed', 'dismiss': None, 'close': 'closed', 'archive': 'archived'}}

WORKFLOW_HINTS = {'relation_context': {'related_docs': ['transaction_trace_record', 'suspicious_pattern_alert', 'fraud_alert', 'chargeback_case'], 'borrowed_fields': ['source alert/transaction context from linked fraud/payment docs'], 'inferred_roles': ['auditor', 'finance officer', 'case owner']}, 'actors': ['auditor', 'finance officer', 'case owner'], 'action_actors': {'create': ['auditor'], 'assign': ['auditor'], 'confirm': ['finance officer'], 'close': ['case owner'], 'archive': ['case owner']}}

SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['transaction_trace_record', 'suspicious_pattern_alert', 'fraud_alert', 'chargeback_case'], 'action_targets': {'create': None, 'triage': None, 'assign': None, 'investigate': None, 'confirm': 'confirmed', 'dismiss': None, 'close': 'closed', 'archive': 'archived'}, 'action_side_effects_file': None}
