...
RELATED_DOCS = [{'doc_id': 'fraud_case', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'anomaly_alert', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'fraud_alert', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'source signal or transaction context from linked alert records'}]
