"""Relation service seed for suspicious_pattern_alert."""
...
RELATED_DOCS = [{'doc_id': 'fraud_case', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'anomaly_alert', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'fraud_alert', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'party_record', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = [{'source_field': 'party', 'doc_id': 'party_record', 'mode': 'context'}]

BORROWED_FIELDS = [{'description': 'source signal or transaction context from linked alert records'}, {'field_id': 'party', 'doc_id': 'party_record', 'description': 'Borrow context from party_record through party.'}]
