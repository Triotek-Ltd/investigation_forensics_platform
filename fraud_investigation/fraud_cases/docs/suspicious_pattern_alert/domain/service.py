"""Business-domain service seed for Suspicious Pattern Alert."""
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['fraud_case', 'anomaly_alert', 'fraud_alert', 'party_record'], 'action_targets': {'create': None, 'triage': None, 'link_case': None, 'dismiss': None, 'archive': 'archived'}, 'action_side_effects_file': None}
