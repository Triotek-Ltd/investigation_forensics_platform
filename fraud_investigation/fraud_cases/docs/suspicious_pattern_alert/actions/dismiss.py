"""Action handler seed for suspicious_pattern_alert:dismiss."""
...
ACTION_ID = "dismiss"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['raised', 'triaged', 'linked_to_case', 'dismissed'], 'transitions_to': None}
