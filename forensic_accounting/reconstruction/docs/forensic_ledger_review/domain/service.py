...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['asset_trace_case', 'reconstruction_entry', 'journal_entry'], 'action_targets': {'create': None, 'review': 'in_review', 'complete': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
