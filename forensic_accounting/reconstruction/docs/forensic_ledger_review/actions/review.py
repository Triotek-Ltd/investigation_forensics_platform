"""Action handler seed for forensic_ledger_review:review."""
...
ACTION_ID = "review"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['opened', 'in_review', 'completed'], 'transitions_to': 'in_review'}
