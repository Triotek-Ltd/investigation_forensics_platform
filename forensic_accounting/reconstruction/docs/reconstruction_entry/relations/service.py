"""Relation service seed for reconstruction_entry."""
...
RELATED_DOCS = [{'doc_id': 'asset_trace_case', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'forensic_ledger_review', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'ledger_posting', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'trace context from asset_trace_case'}, {'description': 'account refs from ledger_posting'}]
