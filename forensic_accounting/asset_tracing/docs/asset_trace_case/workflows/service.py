"""Workflow service seed for asset_trace_case."""
...
STATES = ['opened', 'investigating', 'traced', 'unresolved', 'closed', 'archived']
TERMINAL_STATES = ['closed', 'archived']
ACTION_RULES: dict[str, dict[str, Any]] = {'create': {'allowed_in_states': ['opened', 'investigating', 'traced', 'unresolved'], 'transitions_to': None}, 'assign': {'allowed_in_states': ['opened', 'investigating', 'traced', 'unresolved'], 'transitions_to': None}, 'trace': {'allowed_in_states': ['opened', 'investigating', 'traced', 'unresolved'], 'transitions_to': None}, 'review': {'allowed_in_states': ['opened', 'investigating', 'traced', 'unresolved'], 'transitions_to': None}, 'close': {'allowed_in_states': ['opened', 'investigating', 'traced', 'unresolved'], 'transitions_to': 'closed'}, 'archive': {'allowed_in_states': ['opened', 'investigating', 'traced', 'unresolved'], 'transitions_to': 'archived'}}
