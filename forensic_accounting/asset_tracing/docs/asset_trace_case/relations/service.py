"""Relation service seed for asset_trace_case."""
...
RELATED_DOCS = [{'doc_id': 'reconstruction_entry', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'forensic_ledger_review', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'fraud_case', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'source-case context from fraud_case or investigation_case'}]
