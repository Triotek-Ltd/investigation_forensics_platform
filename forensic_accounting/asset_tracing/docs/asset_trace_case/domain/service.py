...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['reconstruction_entry', 'forensic_ledger_review', 'fraud_case'], 'action_targets': {'create': None, 'assign': None, 'trace': None, 'review': None, 'close': 'closed', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
