"""Action handler seed for asset_trace_case:archive."""
...
ACTION_ID = "archive"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['opened', 'investigating', 'traced', 'unresolved'], 'transitions_to': 'archived'}
