"""Relation service seed for log_source_binding."""
...
RELATED_DOCS = [{'doc_id': 'log_search_case', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'log_finding_record', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'source-system metadata from integration/operations platforms where linked'}]
