"""Action handler seed for log_search_case:complete."""
...
ACTION_ID = "complete"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['opened', 'assigned', 'in_progress', 'completed', 'escalated'], 'transitions_to': None}
