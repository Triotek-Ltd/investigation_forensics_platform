...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['log_source_binding', 'log_finding_record', 'fraud_case', 'investigation_case'], 'action_targets': {'create': None, 'assign': 'in_progress', 'search': None, 'review': None, 'complete': None, 'escalate': 'escalated', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
