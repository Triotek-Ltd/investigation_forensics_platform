"""Relation service seed for log_search_case."""
...
RELATED_DOCS = [{'doc_id': 'log_source_binding', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'log_finding_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'fraud_case', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'investigation_case', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'source-scope metadata from log_source_binding'}]
