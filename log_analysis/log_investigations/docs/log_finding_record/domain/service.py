...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['log_search_case', 'fraud_case', 'investigation_case'], 'action_targets': {'record': None, 'review': 'reviewed', 'accept': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
