"""Relation service seed for log_finding_record."""
...
RELATED_DOCS = [{'doc_id': 'log_search_case', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'fraud_case', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'investigation_case', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'search context from log_search_case'}]
