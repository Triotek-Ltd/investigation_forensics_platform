"""Business-domain service seed for Chain Of Custody Event."""
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['evidence_item', 'forensic_examination'], 'action_targets': {'record': None, 'review': None, 'archive': 'archived'}, 'action_side_effects_file': None}
