...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['chain_of_custody_event', 'forensic_examination', 'device_image_record'], 'action_targets': {'create': None, 'collect': None, 'store': None, 'transfer': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
