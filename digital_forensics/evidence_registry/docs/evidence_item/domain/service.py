...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'collected_at': 'schedule_marker'}, 'search_fields': ['title', 'reference_no', 'description', 'evidence_code', 'evidence_type', 'source_system_device'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'collected', 'lifecycle_states': ['collected', 'stored', 'examined', 'transferred', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'create': None, 'collect': None, 'store': None, 'transfer': None, 'archive': 'archived'}}
