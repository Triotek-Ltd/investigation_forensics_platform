"""Relation service seed for evidence_item."""
...
RELATED_DOCS = [{'doc_id': 'chain_of_custody_event', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'forensic_examination', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'device_image_record', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'source-system or device context from integration/platform docs'}]
