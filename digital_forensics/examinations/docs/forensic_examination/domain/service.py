...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['evidence_item', 'chain_of_custody_event', 'device_image_record', 'investigation_case'], 'action_targets': {'create': None, 'assign': 'in_progress', 'examine': None, 'complete': None, 'close': 'closed', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
