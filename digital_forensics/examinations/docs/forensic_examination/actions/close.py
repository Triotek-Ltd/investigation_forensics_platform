"""Action handler seed for forensic_examination:close."""
...
ACTION_ID = "close"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['opened', 'assigned', 'in_progress', 'completed'], 'transitions_to': 'closed'}
