"""Action handler seed for forensic_examination:archive."""
...
ACTION_ID = "archive"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['opened', 'assigned', 'in_progress', 'completed'], 'transitions_to': 'archived'}
