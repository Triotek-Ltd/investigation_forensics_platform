"""Business-domain service seed for Device Image Record."""
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['evidence_item', 'forensic_examination', 'chain_of_custody_event', 'party_record'], 'action_targets': {'create': None, 'verify': None, 'mount': None, 'archive': 'archived'}, 'action_side_effects_file': None}
