...
ACTION_RULES: dict[str, dict[str, Any]] = {'create': {'allowed_in_states': ['created', 'verified', 'active'], 'transitions_to': None}, 'verify': {'allowed_in_states': ['created', 'verified', 'active'], 'transitions_to': None}, 'mount': {'allowed_in_states': ['created', 'verified', 'active'], 'transitions_to': None}, 'archive': {'allowed_in_states': ['created', 'verified', 'active'], 'transitions_to': 'archived'}}
