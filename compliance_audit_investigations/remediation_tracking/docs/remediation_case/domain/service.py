...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'due_date': 'schedule_marker', 'remediation_status': 'status_flag'}, 'search_fields': ['title', 'reference_no', 'description', 'remediation_code', 'source_investigation', 'remediation_owner'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'opened', 'lifecycle_states': ['opened', 'assigned', 'in_progress', 'verified', 'closed', 'archived'], 'terminal_states': ['closed', 'archived'], 'action_targets': {'create': None, 'assign': 'in_progress', 'track': None, 'verify': None, 'close': 'closed', 'archive': 'archived'}}
