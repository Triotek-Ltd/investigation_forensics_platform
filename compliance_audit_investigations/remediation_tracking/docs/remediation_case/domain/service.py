...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['investigation_case', 'investigation_report', 'corrective_action_plan'], 'action_targets': {'create': None, 'assign': 'in_progress', 'track': None, 'verify': None, 'close': 'closed', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
