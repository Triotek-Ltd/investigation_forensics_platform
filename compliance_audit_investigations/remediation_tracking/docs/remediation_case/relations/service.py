"""Relation service seed for remediation_case."""
...
RELATED_DOCS = [{'doc_id': 'investigation_case', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'investigation_report', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'corrective_action_plan', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'findings/recommendations from linked case or report'}]
