"""Action handler seed for remediation_case:verify."""
...
ACTION_ID = "verify"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['opened', 'assigned', 'in_progress', 'verified'], 'transitions_to': None}
