...
ACTION_RULES: dict[str, dict[str, Any]] = {'create': {'allowed_in_states': ['draft', 'reviewed', 'accepted'], 'transitions_to': None}, 'review': {'allowed_in_states': ['draft', 'reviewed', 'accepted'], 'transitions_to': 'reviewed'}, 'finalize': {'allowed_in_states': ['draft', 'reviewed', 'accepted'], 'transitions_to': None}, 'archive': {'allowed_in_states': ['draft', 'reviewed', 'accepted'], 'transitions_to': 'archived'}}
