"""Relation service seed for investigation_interview_record."""
...
RELATED_DOCS = [{'doc_id': 'investigation_case', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'investigation_report', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'party_record', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = [{'source_field': 'party', 'doc_id': 'party_record', 'mode': 'context'}]

BORROWED_FIELDS = [{'description': 'case context from investigation_case'}, {'field_id': 'party', 'doc_id': 'party_record', 'description': 'Borrow context from party_record through party.'}]
