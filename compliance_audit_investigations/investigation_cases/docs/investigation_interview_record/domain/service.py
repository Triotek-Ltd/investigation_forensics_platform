"""Business-domain service seed for Investigation Interview Record."""
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['investigation_case', 'investigation_report', 'party_record'], 'action_targets': {'create': None, 'review': 'reviewed', 'finalize': None, 'archive': 'archived'}, 'action_side_effects_file': None}
