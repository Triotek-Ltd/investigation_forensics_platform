...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['investigation_case', 'investigation_interview_record', 'remediation_case'], 'action_targets': {'create': None, 'review': 'reviewed', 'approve': 'approved', 'issue': 'issued', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
