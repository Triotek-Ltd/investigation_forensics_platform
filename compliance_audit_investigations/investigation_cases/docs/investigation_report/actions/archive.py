"""Action handler seed for investigation_report:archive."""
...
ACTION_ID = "archive"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['draft', 'reviewed', 'approved', 'issued'], 'transitions_to': 'archived'}
