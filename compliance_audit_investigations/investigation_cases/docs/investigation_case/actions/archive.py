...
ACTION_ID = "archive"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['opened', 'assigned', 'investigating', 'substantiated', 'unsubstantiated'], 'transitions_to': 'archived'}
...
ACTION_CONTRACT: dict[str, Any] = {'rule': {'allowed_in_states': ['opened', 'assigned', 'investigating', 'substantiated', 'unsubstantiated'], 'transitions_to': 'archived'}, 'requires_action_comment': False, 'requires_reason_for_change': False, 'requires_evidence': False, 'is_disposition_action': True, 'creates_submission_snapshot': False, 'creates_official_copy': False, 'requires_signature': False}
